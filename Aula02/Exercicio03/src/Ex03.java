...
public class Ex03 {
    public static void main(String[] args) throws Exception {
        ...
        /*
         Escreva um código que exiba um menu para o usuário 
         com duas opções (1 - continuar, 2 - sair). 
         Exiba o menu até que o usuário digite 2. 
         Caso o usuário informe outro valor diferente de 1 e 2, 
         retornar que o valor é inválido.
        */
